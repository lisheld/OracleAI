...
async def events_at(ctx, *args):
    await ctx.send(call_command('events', args), ephemeral=True)
...
async def odds_at(ctx, *args):
    await ctx.send(call_command('odds', args), ephemeral=True)
...
async def markets_at(ctx, *args):
    await ctx.send(call_command('markets', args), ephemeral=True)
...
@is_premium()
async def best_at(ctx, *args):
    await ctx.send(call_command('best', args), ephemeral=True)
...
@is_premium()
async def scores_at(ctx, *args):
    await ctx.send(call_command('scores', args), ephemeral=True)
...
@is_premium()
async def arb_at(ctx, *args):
    await ctx.send(call_command('arb', args), ephemeral=True)
...
async def leagues_at(ctx, *args):
    await ctx.send(call_command('leagues', args), ephemeral=True)
...
@is_premium()
async def predict_at(ctx, *args):
    await ctx.send(call_command('predict', args), ephemeral=True)
...
@is_premium()
async def advice_at(ctx, *args):
    await ctx.send(call_command('advice', args), ephemeral=True)
...
async def info_at(ctx, *args):
    await ctx.send(call_command('info', args), ephemeral=True)
